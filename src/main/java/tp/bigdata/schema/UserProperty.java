...
public class UserProperty implements org.apache.thrift.TBase<UserProperty, UserProperty._Fields>, java.io.Serializable, Cloneable, Comparable<UserProperty> {
  ...
  private static final org.apache.thrift.protocol.TField USER_PURCHASE_FIELD_DESC = new org.apache.thrift.protocol.TField("user_purchase", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  private UserPurchaseEdge user_purchase; // required
  private UserPurchasePropertyValue property; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    USER_PURCHASE((short)1, "user_purchase"),
  ...
  static {
    ...
    tmpMap.put(_Fields.USER_PURCHASE, new org.apache.thrift.meta_data.FieldMetaData("user_purchase", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, UserPurchaseEdge.class)));
    tmpMap.put(_Fields.PROPERTY, new org.apache.thrift.meta_data.FieldMetaData("property", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, UserPurchasePropertyValue.class)));
  ...
  public UserProperty(
    UserPurchaseEdge user_purchase,
    UserPurchasePropertyValue property)
  {
    this();
  ...
  public UserProperty(UserProperty other) {
    if (other.is_set_user_purchase()) {
      this.user_purchase = new UserPurchaseEdge(other.user_purchase);
    }
    if (other.is_set_property()) {
      this.property = new UserPurchasePropertyValue(other.property);
    }
  }
  ...
  @Override
  public void clear() {
    this.user_purchase = null;
    this.property = null;
  }

  public UserPurchaseEdge get_user_purchase() {
    return this.user_purchase;
  }

  public void set_user_purchase(UserPurchaseEdge user_purchase) {
    this.user_purchase = user_purchase;
  }

  public void unset_user_purchase() {
    this.user_purchase = null;
  }

  /** Returns true if field user_purchase is set (has been assigned a value) and false otherwise */
  public boolean is_set_user_purchase() {
    return this.user_purchase != null;
  }

  public void set_user_purchase_isSet(boolean value) {
    if (!value) {
      this.user_purchase = null;
    }
  }

  public UserPurchasePropertyValue get_property() {
    return this.property;
  }

  public void set_property(UserPurchasePropertyValue property) {
    this.property = property;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case USER_PURCHASE:
      if (value == null) {
        ...
        set_user_purchase((UserPurchaseEdge)value);
      }
      break;
    ...
    case PROPERTY:
      if (value == null) {
        ...
        set_property((UserPurchasePropertyValue)value);
      }
      break;
  ...
  public boolean equals(UserProperty that) {
    ...
    boolean this_present_user_purchase = true && this.is_set_user_purchase();
    boolean that_present_user_purchase = true && that.is_set_user_purchase();
    if (this_present_user_purchase || that_present_user_purchase) {
      if (!(this_present_user_purchase && that_present_user_purchase))
        return false;
      if (!this.user_purchase.equals(that.user_purchase))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_user_purchase = true && (is_set_user_purchase());
    list.add(present_user_purchase);
    if (present_user_purchase)
      list.add(user_purchase);
  ...
  public int compareTo(UserProperty other) {
    ...
    lastComparison = Boolean.valueOf(is_set_user_purchase()).compareTo(other.is_set_user_purchase());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_user_purchase()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.user_purchase, other.user_purchase);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    sb.append("user_purchase:");
    if (this.user_purchase == null) {
      sb.append("null");
    } else {
      sb.append(this.user_purchase);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("property:");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!is_set_user_purchase()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'user_purchase' is unset! Struct:" + toString());
    }
    ...
    if (user_purchase != null) {
      user_purchase.validate();
    }
  }
  ...
  private static class UserPropertyStandardScheme extends StandardScheme<UserProperty> {
        ...
        switch (schemeField.id) {
          case 1: // USER_PURCHASE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.user_purchase = new UserPurchaseEdge();
              struct.user_purchase.read(iprot);
              struct.set_user_purchase_isSet(true);
            } else { 
          ...
          case 2: // PROPERTY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.property = new UserPurchasePropertyValue();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserProperty struct) throws org.apache.thrift.TException {
      ...
      if (struct.user_purchase != null) {
        oprot.writeFieldBegin(USER_PURCHASE_FIELD_DESC);
        struct.user_purchase.write(oprot);
        oprot.writeFieldEnd();
      }
