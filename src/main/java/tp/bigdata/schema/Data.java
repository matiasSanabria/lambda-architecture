...
public class Data implements org.apache.thrift.TBase<Data, Data._Fields>, java.io.Serializable, Cloneable, Comparable<Data> {
  ...
  private static final org.apache.thrift.protocol.TField DATA_UNIT_FIELD_DESC = new org.apache.thrift.protocol.TField("data_unit", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  public DataUnit get_data_unit() {
    return this.data_unit;
  }

  public void set_data_unit(DataUnit data_unit) {
    this.data_unit = data_unit;
  }

  public void unset_data_unit() {
    this.data_unit = null;
  }

  /** Returns true if field data_unit is set (has been assigned a value) and false otherwise */
  public boolean is_set_data_unit() {
    return this.data_unit != null;
  }

  public void set_data_unit_isSet(boolean value) {
    if (!value) {
      this.data_unit = null;
    }
  }
  ...
  public boolean equals(Data that) {
    ...
    boolean this_present_data_unit = true && this.is_set_data_unit();
    boolean that_present_data_unit = true && that.is_set_data_unit();
  ...
  public int hashCode() {
    ...
    boolean present_data_unit = true && (is_set_data_unit());
    list.add(present_data_unit);
    if (present_data_unit)
      list.add(data_unit);
  ...
  public int compareTo(Data other) {
    ...
    lastComparison = Boolean.valueOf(is_set_data_unit()).compareTo(other.is_set_data_unit());
    if (lastComparison != 0) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!is_set_data_unit()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'data_unit' is unset! Struct:" + toString());
    }
        ...
        switch (schemeField.id) {
          case 1: // DATA_UNIT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              ...
              struct.set_data_unit_isSet(true);
            } else { 
